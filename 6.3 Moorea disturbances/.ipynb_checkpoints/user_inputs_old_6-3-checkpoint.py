...
cyclone_years = {1:[4,100], 9:[1,50]} #added the last event as we have an unexplained decline in branching that effects the modelling
...
initial_spawner_cover = [19,7]  # the first element is B+F and the second element is O
...
custom_PSD_T0 = {
    ...
    'Branching': [2.4,6,9.6,10.7,9.8,8.8,7.8,6.8,5.8,4.8,3.9,2.9,2.8,2.7,2.7,2.6,2.6,2.5,2.5,2.4],
    'Foliose': [2.34,8.44,10.31,10.78,9.89,9,8.11,7.23,6.34,5.45,4.56,3.75,3.29,2.82,2.36,1.9,1.44,0.97,0.51,0.51],
    'Other': [0,10.73,12.87,7.72,7.21,6.7,6.19,5.68,5.18,4.67,4.16,3.43,3.38,3.32,3.26,3.21,3.15,3.09,3.04,3]
}
...
real_data = {
    'Year': list(range(year_start, year_start + MaxYear + 1)),
    'RealBranching_Area (%)': [36.5,13,12.8,14.3,17.1,19.5,23,23.5,26,21.5,25.5,25.7,23.5,28.5,29.3,25.5],
    'RealFoliose_Area (%)': [7.5,2.9,1.8,4,1.9,1.2,2.5,3.2,4,4.1,5.6,5.5,2.4,2,2,2],
    'RealOther_Area (%)': [7,8.1,7.4,9.7,11,10.3,11.5,16.3,12.5,16.4,18.4,17.8,19.1,19.5,17.7,18.5] 
}
