...
custom_growth_rate_branching     = 5.4
custom_growth_rate_foliose        = 2.1
...
real_df = pd.DataFrame(real_data)ealOther_Area (%)': [16.3,17.4,18.5,17.4,16.3,15.2,14.1,13.5,12.9,17.2,13.9,15.4] 
}