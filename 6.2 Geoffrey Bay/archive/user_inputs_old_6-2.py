...
dhw_years = {12:13, 15:10, 17:8, 19:12 }
...
cyclone_years = {1:[5,220], 6:[5,100], 7:[5,100]}
...
custom_growth_rate_branching     = 2.9
...
real_data = {
    ...
    'RealBranching_Area (%)': [2.6,2.3,2.1,3.4,1.8,1.5,0.3,1,0.5,1.7,1,1.5,2.7,2.8,2.9,5,3.7,5.7,4.9,3],
    'RealFoliose_Area (%)': [7.3,6,8.9,6.3,7.6,5.6,3.4,2.9,4.2,5.4,8.4,7.6,7.9,8.5,10.4,8.1,14.5,14.2,13.7,8.4],
    'RealOther_Area (%)': [8,5.4,7.8,8,8,6.2,7,5.2,6.1,6.7,3.8,8.5,4.3,5,8.5,4,7.8,7,8.2,6.1] 
}