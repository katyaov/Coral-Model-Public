...
real_data = {
    ...
    'RealBranching_Area (%)': [5.7,6.3,1.2,1.55,1.9,3,4.1,6.05,8,10.5,13,14.2,19.1,18.8,18.2,10],
    'RealFoliose_Area (%)': [2.6,3.2,2.2,2.2,2.2,2.45,2.7,2.7,2.7,2.55,2.4,2.7,2.2,2.8,3,3.3],
    'RealOther_Area (%)': [20.3, 22.3, 16.3,17.4,18.5,17.4,16.3,15.2,14.1,13.5,12.9,17.2,13.9,15.4,17.9,21.6] 
}