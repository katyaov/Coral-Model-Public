# Coral Growth/Decline Model in Python TEST!
...
![Initial coral population estimation algorithm](population_estimation_flowchart.png)
...
2. To setup the environment, navigate to the folder where you saved the code and run the following on the command to create a new environment and install the required packages:
    
    $ conda env create -n coral --file ENV.yml
    
3. Activate the environment by running:
    
    $ conda activate coral
    
4. To run the program on jupyter notebook, type:

    $ jupyter-lab Coral_model_1D.ipynb

5. To deactivate the environment, type:
